...
专著《近场动力学理论与数值方法》的 LaTeX 书籍项目。当前状态：**第1章绪论已完成**（约9000字，10幅插图），**第2章"近场动力学基本理论框架"2.1–2.8节全部完成**（2.1 基本概念、2.2 变形描述、2.3 受力描述与运动方程、2.4 近场动力学状态、2.5 应变能密度与能量守恒、2.6 守恒律相容性条件、2.7 损伤与破坏、2.8 非局部边界条件；含 8 幅 TikZ 图、3 个守恒律严格证明），**第6章6.1节态型理论基本概念与数学表述、6.2节常规态型弹性本构模型已完成**，其余章节仍为骨架。
