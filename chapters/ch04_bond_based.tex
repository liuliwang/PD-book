...
\begin{table}[htbp]
\centering
\caption{PMB 模型微模量率定公式汇总}
\label{tab:rate-summary}
\begin{tabular}{p{0.11\textwidth}p{0.20\textwidth}p{0.17\textwidth}p{0.20\textwidth}p{0.12\textwidth}}
\toprule
...
\begin{tabular}{p{0.16\textwidth}>{\raggedright\arraybackslash}p{0.21\textwidth}>{\raggedright\arraybackslash}p{0.21\textwidth}>{\raggedright\arraybackslash}p{0.22\textwidth}}
\toprule
方法 & 基本思想 & 优点 & 缺点 \\
\midrule
