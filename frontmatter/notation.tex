...
\begin{tabular}{@{}ll@{}}
  ...
  $\underline{e}\langle\boldsymbol{\xi}\rangle$ & 伸长态（extension state），$|\underline{\mathbf{Y}}\langle\boldsymbol{\xi}\rangle|-|\boldsymbol{\xi}|$ \\
  ...
  $\underline{\mathbf{I}}$，$\underline{1}$，$\underline{\mathbf{0}}$ & 单位态（identity state）、标量单位态（scalar identity state）、零态（zero state） \\
